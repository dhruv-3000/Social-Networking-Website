 ...
 <div class="col-sm-3" id="select_user">
	...
	while ($row_user = mysqli_fetch_array($run_user)) {
 	 ...
 	 echo"
 	 	<div class='container-fluid'>
 	 		...
 	 		<img class='img-circle' src='users/$user_image' width='90px' height='80px' title='$user_name'><strong>&nbsp $f_name $l_name</strong><br><br>
 	 		</a>
  ...
  <div class="col-sm-6">
  	 	...
  	 	<?php
  	 	 ...
  	 	 <div id="loaded_msg">
  	 	 	<p><?php if($user_to == $user_to_msg AND $user_from == $user_from_msg){
  	 	 		echo"<div class='message' id='blue' date-toggle='tooltip' title='$msg_date'>$msg_body</div><br><br><br>";} 
  	 	 		else if($user_from == $user_to_msg AND $user_to == $user_from_msg){
  	 	 		echo "<div class='message' id='green' date-toggle='tooltip' title='$msg_date'>$msg_body</div><br><br><br>";
  	 	 	}?>
  	 	 </p>
  	 	 </div>
  	 	 <?php
  	 ...
  	 if (isset($_GET['u_id'])) {
  	 	...
  	 	echo '
  	 	 <form>
	     	...
	     	<textarea disabled class="form-control" placeholder="Enter your Messeage"></textarea>
      ...
      <form action="" method="POST">
	     	<textarea  class="form-control" placeholder="Enter your Messeage" name="msg_box" id="message_textarea"></textarea>
