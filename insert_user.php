	...
	if(isset($_POST['sign_up'])){
		...
		$rand = rand(1,3); //Random number between 1 and 3
			...
			if($rand == 1){
				...
				$profile_pic = "three.jpg";
			}
			else if($rand == 3){
				$profile_pic = "four.png";
			}
		...
		VALUES('$first_name','$last_name','$username','Hello.This is default status!','...','$pass','$email','$country','$gender','$birthday','$profile_pic','new.jpg',NOW(),'$status','$posts','Iwanttoputading intheuniverse.')";
